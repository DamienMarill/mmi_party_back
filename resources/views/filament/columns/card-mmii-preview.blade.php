@php
    ...
    // CardInstance → cardVersion.cardTemplate.mmii, CardVersion → cardTemplate.mmii, CardTemplate → mmii
    if ($record instanceof \App\Models\CardInstance) {
        $mmii = $record->cardVersion?->cardTemplate?->mmii;
    } elseif ($record instanceof \App\Models\CardVersion) {
        $mmii = $record->cardTemplate?->mmii;
    } else {
        $mmii = $record->mmii;
    }
